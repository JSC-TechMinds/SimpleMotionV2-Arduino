...
- Search [existing pull requests and issues](https://github.com/JSC-TechMinds/SimpleMotionV2-Arduino/issues?q=) to be sure it hasn't already been reported. If you have additional information to provide about an existing issue then please comment on that issue.
...
## Pull Requests
- Search [existing pull requests](https://github.com/JSC-TechMinds/SimpleMotionV2-Arduino/pulls?q=) to see if one has already been submitted for this change. Search the [issues](https://github.com/JSC-TechMinds/SimpleMotionV2-Arduino/issues?q=is%3Aissue) to see if there has been a discussion on this topic and whether your pull request can close any issues.
...
- After your pull request is merged please update the documentation if the changes require it:
  - Edit appropriate [Wiki pages](https://github.com/JSC-TechMinds/SimpleMotionV2-Arduino/wiki).
...
```bash
git clone git@github.com:JSC-TechMinds/SimpleMotionV2-Arduino.git
```
